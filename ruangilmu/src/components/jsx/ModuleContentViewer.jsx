...
const ModuleContentViewer = ({ onModuleChange }) => {
  ...
  useEffect(() => {
    const fetchModulesList = async () => {
      setIsLoading(true);
      try {
        const response = await apiService.get(`https://backend-ruangilmu-production.up.railway.app/course/${courseId}/module`);
  ...
  useEffect(() => {
    ...
    const checkFinalExamStatus = async () => {
      ...
      try {
        const response = await apiService.get(`https://backend-ruangilmu-production.up.railway.app/course/${courseId}/final-exam`);
  ...
  const checkCertificateStatus = async () => {
    setIsCheckingCertificate(true);
    try {
      const response = await apiService.get(`https://backend-ruangilmu-production.up.railway.app/course/${courseId}/certificate`);
  ...
  const fetchModuleDetails = async (moduleId) => {
    const response = await apiService.get(`https://backend-ruangilmu-production.up.railway.app/course/${courseId}/module/${moduleId}`);
  ...
  const fetchQuizData = async (moduleId, currentModuleData = null) => {
    try {
      const response = await apiService.get(`https://backend-ruangilmu-production.up.railway.app/course/${courseId}/module/${moduleId}/quiz`);
  ...
  const markModuleAsCompleted = async (moduleId) => {
    ...
    try {
      const response = await apiService.post(`https://backend-ruangilmu-production.up.railway.app/course/${courseId}/module/${moduleId}/complete`, {});
