...
const EditProfile = () => {
  ...
  const fetchUserProfile = async (token) => {
    ...
    try {
      setIsLoading(true)
      const response = await apiService.get('https://backend-ruangilmu-production.up.railway.app/user/me');
      ...
      if (userData.user_profile) {
        setProfilePic(`https://backend-ruangilmu-production.up.railway.app/uploads/userprofile/${userData.user_profile}`);
      }
  ...
  const uploadProfilePicture = async (file) => {
    ...
    try {
      ...
      const response = await fetch('https://backend-ruangilmu-production.up.railway.app/user/update-profile-picture', {
        method: 'POST',
        headers: {
      ...
      if (data.data && data.data.user && data.data.user.user_profile) {
        setProfilePic(`https://backend-ruangilmu-production.up.railway.app/uploads/userprofile/${data.data.user.user_profile}`);
      }
      ...
      if (user.user_profile) {
        setProfilePic(`https://backend-ruangilmu-production.up.railway.app/uploads/userprofile/${user.user_profile}`);
      } else {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await apiService.post('https://backend-ruangilmu-production.up.railway.app/user/update-profile', {
        nama: fullName,
