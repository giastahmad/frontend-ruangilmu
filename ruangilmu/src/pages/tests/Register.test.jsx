...
describe('Register Page', () => {
    ...
    describe('Form Submission', () => {
        test('handles successful registration', async () => {
            ...
            expect(fetch).toHaveBeenCalledWith('https://backend-ruangilmu-production.up.railway.app/auth/register', {
                method: 'POST',
                headers: {
    ...
    describe('Google Sign-in', () => {
        ...
        test('handles successful Google sign-in', async () => {
            ...
            await waitFor(() => {
                expect(fetch).toHaveBeenCalledWith('https://backend-ruangilmu-production.up.railway.app/auth/oauth-google', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
