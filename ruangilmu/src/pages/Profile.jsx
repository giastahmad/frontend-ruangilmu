...
const ProfilePage = () => {
  ...
  const fetchEnrolledCourses = async () => {
    try {
      const response = await apiService.get('https://backend-ruangilmu-production.up.railway.app/courses/user/enrolled');
  ...
  const fetchCertificates = async () => {
    try {
      const response = await apiService.get('https://backend-ruangilmu-production.up.railway.app/course/certificates');
            ...
            <div className="bg-white rounded-lg shadow-md p-6 sticky top-6">
              <div className="flex flex-col items-center">
                <div className="relative mb-4">
                  <img
                    src={user.user_profile ? `https://backend-ruangilmu-production.up.railway.app/uploads/userprofile/${user.user_profile}` : '/images/profile.png'}
                    alt="Profile"
